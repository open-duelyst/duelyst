...
exports.up = function(knex, Promise) {
	return Promise.all([
		...
		knex.schema.createTable('invite_codes', function (table) {
		...
		knex.schema.createTable('password_reset_tokens', function (table) {
			table.string('reset_token',36).notNullable().primary()
			table.string('user_id',36).notNullable()
			table.dateTime('created_at').notNullable().defaultTo(knex.fn.now())
		}),
		knex.schema.createTable('email_verify_tokens', function (table) {
			table.string('verify_token',36).notNullable().primary()
			table.string('user_id',36).notNullable()
			table.dateTime('created_at').notNullable().defaultTo(knex.fn.now())
		}),
		knex.schema.createTable('user_buddies', function (table) {
		...
		knex.schema.createTable('user_rank_events', function (table) {
		...
		knex.schema.createTable('user_rank_history', function (table) {
			table.string('user_id',36).notNullable().index()
			table.dateTime('starting_at').notNullable()
		...
		knex.schema.createTable('user_charges', function (table) {
		...
		knex.schema.createTable('user_gauntlet_run', function (table) {
			table.string('user_id',36).notNullable().primary()
		...
		knex.schema.createTable('user_gauntlet_run_complete', function (table) {
			table.string('id',36).notNullable().primary()
			table.string('user_id',36).notNullable().index()
			table.integer('win_count').notNullable().defaultTo(knex.raw("0"))
			table.integer('loss_count').notNullable().defaultTo(knex.raw("0"))
		...
		knex.schema.createTable('user_gauntlet_tickets', function (table) {
			table.string('id',36).notNullable().primary()
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_gauntlet_tickets_used', function (table) {
			table.string('id',36).notNullable().primary()
			table.string('user_id',36).notNullable().index()
			table.string('transaction_type',36)
			table.string('transaction_id',36)
		...
		knex.schema.createTable('user_spirit_orbs', function (table) {
			table.string('id',36).notNullable().primary()
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_spirit_orbs_opened', function (table) {
			table.string('id',36).notNullable().primary()
			table.string('user_id',36).notNullable().index()
			table.integer('card_set',36).notNullable().defaultTo(knex.raw("1"))
			table.string('transaction_type',36)
		...
		knex.schema.createTable('user_cards', function (table) {
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_card_log', function (table) {
			table.string('id',36).notNullable().primary()
			table.string('user_id',36).notNullable().index()
			table.integer('card_id').notNullable()
			table.dateTime('created_at').notNullable().defaultTo(knex.fn.now())
		...
		knex.schema.createTable('user_card_collection', function (table) {
		...
		knex.schema.createTable('user_currency_log', function (table) {
			table.string('id',36).notNullable().primary()
			table.string('user_id',36).notNullable().index()
			table.dateTime('created_at').notNullable().defaultTo(knex.fn.now())
			table.integer('gold')
		...
		knex.schema.createTable('user_decks', function (table) {
			table.string('id',36).notNullable().primary()
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_progression', function (table) {
			table.string('user_id',36).notNullable().primary()
		...
		knex.schema.createTable('user_progression_days', function (table) {
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_faction_progression', function (table) {
			table.string('user_id',36).notNullable().index()
			table.integer('faction_id').notNullable()
		...
		knex.schema.createTable('user_faction_progression_events', function (table) {
			table.string('user_id',36).notNullable().index()
			table.integer('faction_id').notNullable()
			table.string('game_id',36).notNullable()
		...
		knex.schema.createTable('user_quests', function (table) {
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_quests_complete', function (table) {
			table.string('id',36).primary()
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_rewards', function (table) {
			table.string('id',36).notNullable().primary()
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_new_player_progression', function (table) {
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_challenges', function (table) {
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_emotes', function (table) {
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_game_counters', function (table) {
			table.string('user_id',36).notNullable().index()
		...
		knex.schema.createTable('user_game_faction_counters', function (table) {
			table.string('user_id',36).notNullable().index()
			table.string('game_type').notNullable()
			table.integer('faction_id').notNullable()
			table.integer('game_count').notNullable().defaultTo(knex.raw("0"))
		...
		knex.schema.createTable('user_game_season_counters', function (table) {
			table.string('user_id',36).notNullable().index()
			table.string('game_type').notNullable()
