...
desktopPlatforms.forEach(platform => {
	gulp.task(`desktop:build:${platform}`, (cb) => desktop.build({platform: platform}, cb))
	gulp.task(`desktop:build:steam:${platform}`, (cb) => desktop.build({platform: platform, steam: true}, cb))
