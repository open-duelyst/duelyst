...
var RadialBlurTo = cc.ActionInterval.extend({
	...
	ctor: function (duration, position, radialBlurSpread, radialBlurDeadZone, radialBlurStrength) {
		cc.ActionInterval.prototype.ctor.call(this);
		this.initWithDuration(duration, position, radialBlurSpread, radialBlurDeadZone, radialBlurStrength);
	},

	initWithDuration:function (duration, position, radialBlurSpread, radialBlurDeadZone, radialBlurStrength) {
