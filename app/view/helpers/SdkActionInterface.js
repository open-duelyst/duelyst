 ...
 */
var SdkActionInterface = function (sdkAction, sdkStepInterface) {
...
SdkActionInterface.prototype = {
	...
	setSdkAction: function (val) {
		this._sdkAction = val;
	},

	getSdkAction: function () {
		return this._sdkAction;
	},

	setSdkStepInterface: function (val) {
		this._sdkStepInterface = val;
	},

	getSdkStepInterface: function () {
