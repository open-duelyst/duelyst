...
var FXRiftFireSprite = FXSprite.extend({
  shaderKey: 'RiftFire',
  ...
  _createRenderCmd() {
    ...
    return new FXRiftFireSprite.WebGLRenderCmd(this);
  },
...
FXRiftFireSprite.WebGLRenderCmd = function (renderable) {
  FXSprite.WebGLRenderCmd.call(this, renderable);
};
const proto = FXRiftFireSprite.WebGLRenderCmd.prototype = Object.create(FXSprite.WebGLRenderCmd.prototype);
proto.constructor = FXRiftFireSprite.WebGLRenderCmd;
...
FXRiftFireSprite.create = function (options, sprite) {
  return FXSprite.create.call(this, options, sprite || new FXRiftFireSprite(options));
};

module.exports = FXRiftFireSprite;
