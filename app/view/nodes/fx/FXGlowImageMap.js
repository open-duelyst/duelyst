...
var FXGlowImageMap = BaseSprite.extend({
	...
	getLevelsInWhite: function () {
		return this.levelsInWhite;
	},

	setLevelsInWhite: function (val) {
		this.levelsInWhite = val;
	},

	getLevelsInBlack: function () {
		return this.levelsInBlack;
	},

	setLevelsInBlack: function (val) {
	...
	setGlowColor: function (glowColor) {
		this.glowColor = glowColor;
	},

	animateGlowColor: function (duration, glowColor) {
...
var proto = FXGlowImageMap.WebGLRenderCmd.prototype = Object.create(BaseSprite.WebGLRenderCmd.prototype);
