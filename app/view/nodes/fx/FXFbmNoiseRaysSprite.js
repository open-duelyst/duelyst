...
/****************************************************************************
FXFbmNoiseRaysSprite
 ****************************************************************************/

var FXFbmNoiseRaysSprite = FXSprite.extend({
	shaderKey: "FbmNoiseRays",
	...
	spriteIdentifier: RSX.noise_rays_area.img,

	_createRenderCmd: function(){
		if(cc._renderType === cc._RENDER_TYPE_CANVAS) {
			return this._super();
		} else {
			return new FXFbmNoiseRaysSprite.WebGLRenderCmd(this);
		}
	},
...
var proto = FXFbmNoiseRaysSprite.WebGLRenderCmd.prototype = Object.create(FXSprite.WebGLRenderCmd.prototype);
...
FXFbmNoiseRaysSprite.create = function(options, sprite) {
	return FXSprite.create.call(this, options, sprite || new FXFbmNoiseRaysSprite(options));
};

module.exports = FXFbmNoiseRaysSprite;
