...
var LensNoiseSprite = BaseSprite.extend({
	...
	setFlareAmount: function(val) {
		this._flareAmount = val;
	},

	getFlareAmount: function() {
...
var proto = LensNoiseSprite.WebGLRenderCmd.prototype = Object.create(BaseSprite.WebGLRenderCmd.prototype);
...
proto.rendering = function () {
	...
	var shaderProgram = cc.shaderCache.programForKey("LensNoise");
	shaderProgram.use();
