...
var FXLensFlareSprite = FXSprite.extend({
	...
	setPulseRate: function (pulseRate) {
		this.pulseRate = pulseRate;
	},
	setRampThreshold: function (rampThreshold) {
		this.rampThreshold = rampThreshold;
	},
	setArmLength: function (armLength) {
		this.armLength = this._armLengthTarget = armLength;
	},
	setWispSize: function (wispSize) {
		this.wispSize = this._wispSizeTarget = wispSize;
	},
	setFlareSize: function (flareSize) {
...
var proto = FXLensFlareSprite.WebGLRenderCmd.prototype = Object.create(FXSprite.WebGLRenderCmd.prototype);
