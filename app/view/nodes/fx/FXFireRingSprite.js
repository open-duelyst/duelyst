...
var FXFireRingSprite = FXSprite.extend({
	shaderKey: "FireRing",
	...
	_createRenderCmd: function(){
		if(cc._renderType === cc._RENDER_TYPE_CANVAS) {
			...
			return new FXFireRingSprite.WebGLRenderCmd(this);
		}
	},
...
var proto = FXFireRingSprite.WebGLRenderCmd.prototype = Object.create(FXSprite.WebGLRenderCmd.prototype);
...
FXFireRingSprite.create = function(options, sprite) {
	return FXSprite.create.call(this, options, sprite || new FXFireRingSprite(options));
};

module.exports = FXFireRingSprite;
