...
var VoronoiPrismaticSprite = require("./VoronoiPrismaticSprite");
...
var PrismaticPlayCardNode = cc.Node.extend({
	...
	ctor: function () {
		...
		this.whenRequiredResourcesReady().then(function (requestId) {
			...
			// particles
			var randomRangeX = CONFIG.TILESIZE * 0.25;
			var randomRangeY = CONFIG.TILESIZE * 0.25;
	...
	_showFloorGradient: function (duration, delay) {
		this._gradientFloorSprite.setVisible(false);
	...
	_showSoftRays: function (duration, delay) {
	...
	_showSoftRay: function (sprite, duration, delay, basePosition, rayOffset) {
		var rayOpacity = this._rayOpacity;
		var rayScale = this._rayScale;
	...
	_showHardRays: function (duration, delay) {
	...
	_showHardRay: function (sprite, duration, delay, basePosition, rayOffset) {
		var rayOpacity = this._rayOpacity;
		var rayScale = this._rayScale;
		sprite.setVisible(false);
		sprite.runAction(cc.sequence(
