...
var ChooseFactionLayer = require("./ChooseFactionLayer");
var ChooseCardLayer = require("./ChooseCardLayer");
var DeckLayer = require("./DeckLayer");
var DeckStatsLayer = require("./DeckStatsLayer");
var RunLayer = require('./RunLayer');
var StartLayer = require('./StartLayer');
var RewardsLayer = require('./RewardsLayer');

/****************************************************************************
 ArenaLayer
 ****************************************************************************/

var ArenaLayer = FXCompositeLayer.extend({
	 ...
	 * @returns {Promise}
	 */
	showStartArenaRunScreen: function() {
		...
		return this.transitionCurrentScreenOut().then(function () {
			...
			var ticketCount = this.dataSource.getTicketCount();
	 ...
	 * @returns {Promise}
	 */
	showFactionSelectScreen: function(arenaRunData) {
		this.showFactionVisualsForFactionId(null,null);
		...
		return this.transitionCurrentScreenOut().then(function () {
			...
			return this.outerLayer.transitionIn().then(function () {
				return this.outerLayer.showFactionOptions(arenaRunData.faction_choices);
			}.bind(this));
		}.bind(this));
	},
	 ...
	 * @returns {Promise}
	 */
	showCardSelectScreen: function(arenaRunData) {
	...
	selectCard: function(selectedSdkCard, unselectedSdkCards) {
		var selectCardPromise = this.delegate.selectCard(selectedSdkCard, unselectedSdkCards);

		// wait for select to resolve and then add the card to deck
		selectCardPromise.then(function(){
	 ...
	 * @returns {Promise}
	 */
	showArenaRunScreen: function(arenaRunData,wonLastGauntletGame) {
		return this.transitionCurrentScreenOut().then(function () {
			...
			var generalId = this.dataSource.getArenaRunGeneralId();
	 ...
	 * @returns {Promise}
	 */
	showArenaRewardsScreen: function(arenaRunData) {
