...
class SisterAchievement extends Achievement
  @id: "windSister"
  @title: i18next.t("achievements.wind_sister_title")
  @description: i18next.t("achievements.wind_sister_desc")
  @progressRequired: 1
  @rewards:
    cards: [
