...
class SisterAchievement extends Achievement
  @id: "sunSister"
  @title: i18next.t("achievements.sun_sister_title")
  @description: i18next.t("achievements.sun_sister_desc")
  @progressRequired: 1
  @rewards:
    cards: [
