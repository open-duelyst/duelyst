...
class SisterAchievement extends Achievement
  @id: "shadowSister"
  @title: i18next.t("achievements.shadow_sister_title")
  @description: i18next.t("achievements.shadow_sister_desc")
  @progressRequired: 1
  @rewards:
    cards: [
