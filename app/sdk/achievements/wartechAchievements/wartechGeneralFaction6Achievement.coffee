...
class WartechGeneralFaction6Achievement extends Achievement
  @id: "wartechGeneralFaction6Achievement"
  @title: i18next.t("achievements.wartech_general_achievement_title",{faction_name:i18next.t("factions.faction_6_abbreviated_name")})
  @description: i18next.t("achievements.wartech_general_achievement_desc",{faction_name:i18next.t("factions.faction_6_abbreviated_name")})
  @progressRequired: 10
  @rewards:
    cards: [
