...
class BeginnerVanarChallenge5 extends Challenge
  ...
  @type: "BeginnerVanarChallenge5"
  type: "BeginnerVanarChallenge5"
  categoryType: ChallengeCategory.starter.type

  name: i18next.t("challenges.beginner_vanar_5_title")
  description:i18next.t("challenges.beginner_vanar_5_description")
  iconUrl: RSX.speech_portrait_vanar.img

  _musicOverride: RSX.music_battlemap_vanar.audio

  otkChallengeStartMessage: i18next.t("challenges.beginner_vanar_5_start")
  ...
  setupBoard: (gameSession) ->
    ...
    @applyCardToBoard({id: Cards.Faction6.ArcticRhyno}, 1, 2, myPlayerId)
