...
class BeginnerAbyssianChallenge6 extends Challenge
  ...
  @type: "BeginnerAbyssianChallenge6"
  type: "BeginnerAbyssianChallenge6"
  categoryType: ChallengeCategory.starter.type

  name:i18next.t("challenges.beginner_abyss_6_title")
  description:i18next.t("challenges.beginner_abyss_6_description")
  iconUrl: RSX.speech_portrait_abyssian.img

  _musicOverride: RSX.music_battlemap_abyssian.audio

  otkChallengeStartMessage: i18next.t("challenges.beginner_abyss_6_start")
  ...
  setupBoard: (gameSession) ->
    ...
    @applyCardToBoard({id: Cards.Faction3.Pyromancer},3,2,opponentPlayerId)
    @applyCardToBoard({id: Cards.Faction3.SandHowler},4,1,opponentPlayerId)
    @applyCardToBoard({id: Cards.Faction3.SandHowler},4,3,opponentPlayerId)
    @applyCardToBoard({id: Cards.Neutral.KomodoCharger},7,3,opponentPlayerId)
