...
class ModifierMyMoveWatchSpawnEntity extends ModifierMyMoveWatch
  ...
  type:"ModifierMyMoveWatchSpawnEntity"
  @type:"ModifierMyMoveWatchSpawnEntity"

  @description:"After this minion moves, summon %X"
  ...
  onMyMoveWatch: (action) ->
    ...
    if @getGameSession().getIsRunningAsAuthoritative()
      ...
      spawnPositions = UtilsGameSession.getRandomNonConflictingSmartSpawnPositionsForModifier(@, ModifierMyMoveWatchSpawnEntity)
