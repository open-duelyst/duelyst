...
class ModifierOpeningGambitApplyModifiersToDeckAndHand extends ModifierOpeningGambit
  ...
  type:"ModifierOpeningGambitApplyModifiersToDeckAndHand"
  @type:"ModifierOpeningGambitApplyModifiersToDeckAndHand"
  ...
  cardType: null # type of card to target
  raceId: null # race of cards to target

  fxResource: ["FX.Modifiers.ModifierOpeningGambit", "FX.Modifiers.ModifierGenericBuff"]

  @createContextObject: (modifiersContextObjects, managedByCard=false, applyToOwnPlayer=false, applyToEnemyPlayer=false, cardType=null, raceId=null, description, options) ->
