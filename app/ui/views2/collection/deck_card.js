...
var DeckCardCompositeView = CardCompositeView.extend({
  ...
  onChangedOptions: function () {
    ...
    if(htmlData) {
      ...
      this.$el.popover({trigger: "manual", container: CONFIG.COLLECTION_SELECTOR, viewport: CONFIG.COLLECTION_SELECTOR, placement: this._positionPopover.bind(this), html: true, content: this._cardData});
    }
  },
