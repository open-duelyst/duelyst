...
const Animation = require('web-animations-js');

const BBMView = Backbone.Marionette.View;
const BBMRegion = Backbone.Marionette.Region;
...
var Animations = {
  ...
  _getAnimationForView(view) {
    const id = view instanceof $ ? view.data('_animationId') : view._animationId;
    return Animations._animationsById[id];
  },

  _storeAnimationForView(view, animation) {
    const id = Animations._animationId++;
    if (view instanceof $) {
   ...
   * @returns {Animation}
   */
  animate(callback, duration, delay) {
    ...
    const animation = callback(view, $el, el, duration, delay);
   ...
   */
  animateIn(callback, duration, delay) {
    return Animations.animate.call(this, (view, $el, el, duration, delay) => {
      // execute callback to generate animation
      const animation = callback(view, $el, el, duration, delay);
   ...
   * @see Animations.animate
   */
  animateOut(callback, duration, delay) {
    return Animations.animate.call(this, (view, $el, el, duration, delay) => {
      // execute callback to generate animation
      const animation = callback(view, $el, el, duration, delay);
  ...
  stop() {
    let view; let
      $el;
    if (this instanceof BBMView || this instanceof BBMRegion) { view = this; $el = this.$el; } else { view = $el = this; }
    const animation = Animations._getAnimationForView(view);
    if (animation != null) {
  ...
  fadeIn(duration, delay) {
    return Animations.animateIn.call(this, (view, $el, el, duration, delay) => {
      if (delay > 0) {
        $el.css('opacity', 0.0);
      }
  ...
  fadeOut(duration, delay) {
    return Animations.animateOut.call(this, (view, $el, el, duration, delay) => el.animate([
      { opacity: 1.0 },
      { opacity: 0.0 },
    ], {
      duration,
   ...
   * @see Animations.animateIn
   */
  fadeZoomUpIn(duration, delay, translateX, translateY, scaleStart) {
    return Animations.animateIn.call(this, (view, $el, el, duration, delay) => {
   ...
   * @see Animations.animateOut
   */
  fadeZoomDownOut(duration, delay, translateX, translateY) {
    return Animations.animateOut.call(this, (view, $el, el, duration, delay) => {
      if (translateX == null) { translateX = 0; }
      if (translateY == null) { translateY = 0; }
   ...
   * @see Animations.animateIn
   */
  fadeZoomDownIn(duration, delay, translateX, translateY) {
    return Animations.animateIn.call(this, (view, $el, el, duration, delay) => {
      if (translateX == null) { translateX = 0; }
      if (translateY == null) { translateY = 0; }
      if (delay > 0) {
   ...
   * @see Animations.animateIn
   */
  fadeZoomFlashUpIn(duration, delay, translateX, translateY) {
    return Animations.animateIn.call(this, (view, $el, el, duration, delay) => {
      if (translateX == null) { translateX = 0; }
      if (translateY == null) { translateY = 0; }
      if (delay > 0) {
   ...
   * @see Animations.animateIn
   */
  fadeZoomRotateFlashUpIn(duration, delay, translateX, translateY) {
    return Animations.animateIn.call(this, (view, $el, el, duration, delay) => {
      if (translateX == null) { translateX = 0; }
      if (translateY == null) { translateY = 0; }
      if (delay > 0) {
      ...
      const rotateY = (0.5 - Math.random()) * 90;
      const rotateZ = (0.5 - Math.random()) * 30;
      const translateZ = -(150 + Math.random() * 100);
