...
describe("achievements module", function() {
	...
	describe("Seven Sisters Achievement", function() {
		...
		it('expect that collecting some, but not all, Lyonar rares does not award the Sun Sister achievement', function() {
			...
			var allRareCardIds = SDK.GameSession.getCardCaches().getCardSet(SDK.CardSet.Core).getFaction(SDK.Factions.Faction1).getRarity(SDK.Rarity.Rare).getIsCollectible(true).getIsUnlockable(false).getIsPrismatic(false).getCardIds();
		...
		it('expect that collecting a combination of all normal and prismatic Songhai rares awards the Lightning Sister achievement', function() {
			...
			var allRareCardIds = SDK.GameSession.getCardCaches().getCardSet(SDK.CardSet.Core).getFaction(SDK.Factions.Faction2).getRarity(SDK.Rarity.Rare).getIsCollectible(true).getIsUnlockable(false).getIsPrismatic(false).getCardIds();
		...
		it('expect that collecting a combination of all normal and prismatic Vetruvian rares awards the Sand Sister achievement', function() {
			...
			var allRareCardIds = SDK.GameSession.getCardCaches().getCardSet(SDK.CardSet.Core).getFaction(SDK.Factions.Faction3).getRarity(SDK.Rarity.Rare).getIsCollectible(true).getIsUnlockable(false).getIsPrismatic(false).getCardIds();
		...
		it('expect that collecting a combination of all normal and prismatic Abyssian rares awards the Shadow Sister achievement', function() {
			...
			var allRareCardIds = SDK.GameSession.getCardCaches().getCardSet(SDK.CardSet.Core).getFaction(SDK.Factions.Faction4).getRarity(SDK.Rarity.Rare).getIsCollectible(true).getIsUnlockable(false).getIsPrismatic(false).getCardIds();
		...
		it('expect that collecting a combination of all normal and prismatic Magmar rares awards the Earth Sister achievement', function() {
			...
			var allRareCardIds = SDK.GameSession.getCardCaches().getCardSet(SDK.CardSet.Core).getFaction(SDK.Factions.Faction5).getRarity(SDK.Rarity.Rare).getIsCollectible(true).getIsUnlockable(false).getIsPrismatic(false).getCardIds();
		...
		it('expect that collecting a combination of all normal and prismatic Vanar rares awards the Wind Sister achievement', function() {
			...
			var allRareCardIds = SDK.GameSession.getCardCaches().getCardSet(SDK.CardSet.Core).getFaction(SDK.Factions.Faction6).getRarity(SDK.Rarity.Rare).getIsCollectible(true).getIsUnlockable(false).getIsPrismatic(false).getCardIds();
		...
		it('expect that collecting a combination of all normal and prismatic Neutral rares awards the Sworn Sister achievement', function() {
			...
			var allRareCardIds = SDK.GameSession.getCardCaches().getCardSet(SDK.CardSet.Core).getFaction(SDK.Factions.Neutral).getRarity(SDK.Rarity.Rare).getIsCollectible(true).getIsUnlockable(false).getIsPrismatic(false).getCardIds();

			return knex.transaction(function(tx){
				var cards = _.flatten(_.map(allRareCardIds,function(c) { return [c,c,SDK.Cards.getPrismaticCardId(c)] }))
