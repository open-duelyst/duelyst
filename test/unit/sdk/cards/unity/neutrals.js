...
describe("unity", function() {
	describe("neutrals", function(){
		...
		it('expect ghoulie to be affected by golem buffs', function() {
	        ...
	        var ghoulie = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Ghoulie}, 4, 2, gameSession.getPlayer1Id());
		...
		it('expect ghoulie to be affected by arcanyst buffs', function() {
			var gameSession = SDK.GameSession.getInstance();
	        var board = gameSession.getBoard();
	        var player1 = gameSession.getPlayer1();
		...
		it('expect ghoulie to be affected by vespyr buffs', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			...
			var ghoulie = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Ghoulie}, 2, 2, gameSession.getPlayer1Id());
		...
		it('expect ghoulie to be affected by dervish buffs', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			...
			var ghoulie = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Ghoulie}, 5, 1, gameSession.getPlayer1Id());
		...
		it('expect ghoulie to be affected by battle pet buffs', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;

			var ghoulie = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Ghoulie}, 2, 1, gameSession.getPlayer1Id());
			...
			var action = ghoulie.actionMove({ x: 4, y: 1 });
			gameSession.executeAction(action);
		...
		it('expect grimes to summon a random minion from a tribe nearby when played', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;
			...
			var tribal = board.getFriendlyEntitiesAroundEntity(board.getUnitAtPosition({x:5,y:2}));

			// neutral race Id = 0.  anything else is a tribal.
			expect(tribal[0].getRaceId()).to.not.equal(0);
		});

		it('expect grimes to summon a random minion from a tribe nearby when dying', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;

			var grimes = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Grimes}, 5, 2, gameSession.getPlayer1Id());

			UtilsSDK.executeActionWithoutValidation(new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {id: SDK.Cards.Spell.PhoenixFire}));
			var playCardFromHandAction = player1.actionPlayCardFromHand(0, 5, 2);
			gameSession.executeAction(playCardFromHandAction);

			var tribal = board.getFriendlyEntitiesAroundEntity(grimes);

			// neutral race Id = 0.  anything else is a tribal.
			expect(tribal[0].getRaceId()).to.not.equal(0);
		});

		it('expect loreweaver to not draw an additional copy of a spell not drawn from your deck', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;

			var loreweaver = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Duplicator}, 5, 2, gameSession.getPlayer1Id());
		...
		it('expect loreweaver to draw an additional copy of a spell drawn from your deck', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;
		...
		it('expect celebrant to create a mana spring nearby', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			...
			var manatile = board.getTileAtPosition({x:2,y:2},true);

			expect(manatile.getId()).to.equal(SDK.Cards.Tile.BonusMana);
		});
		it('expect blue conjurer to put a random arcanyst in your hand whenever you play a spell', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();

			var blueConjurer = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.BlueConjurer}, 5, 2, gameSession.getPlayer1Id());
		...
		it('expect EMP to dispel everything when played', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			...
			var shadowWatcher = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction4.ShadowWatcher}, 5, 2, gameSession.getPlayer1Id());
		...
		it('expect EMP to break all artifacts when played', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
		...
		it('expect boulder breacher to make enemies unable to counterattack when played with a golem on board', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;

			var golem = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.BrightmossGolem}, 7, 2, gameSession.getPlayer1Id());
			var golem2 = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.BrightmossGolem}, 7, 3, gameSession.getPlayer2Id());
		...
		it('expect feralu to give any friendly minion with a tribe +1/+1', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			...
			var feralu = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Feralu}, 5, 1, gameSession.getPlayer1Id());
			var dervish = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction3.Dunecaster}, 5, 2, gameSession.getPlayer1Id());
			var ghoulie = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Ghoulie}, 5, 3, gameSession.getPlayer1Id());
			var golem = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.BoulderBreacher}, 5, 4, gameSession.getPlayer1Id());
			var arcanyst = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Duplicator}, 5, 0, gameSession.getPlayer1Id());
			var battlepet = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Yun}, 4, 0, gameSession.getPlayer1Id());
			var structure = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.Bastion}, 4, 1, gameSession.getPlayer1Id());
		...
		it('expect trinity wing to draw 3 teachings of the dragon when played with an arcanyst on board', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;

			var arcanyst = UtilsSDK.applyCardToBoard({id: SDK.Cards.Neutral.BlueConjurer}, 5, 0, gameSession.getPlayer1Id());
		...
		it('expect lesson of wisdom to restore 3 health to anything', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;
			...
			var playCardFromHandAction1 = player1.actionPlayCardFromHand(0, 0, 2);
			gameSession.executeAction(playCardFromHandAction1);

			expect(gameSession.getGeneralForPlayer1().getDamage()).to.equal(2);
		});
		it('expect lesson of power to deal 2 damage to anything', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;
		...
		it('expect lesson of courage to give your general +1 attack', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;
