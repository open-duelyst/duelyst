...
describe("bloodstorm", function() {
	describe("faction2", function(){
		...
		it('expect whiplash to deal 2 damage to the enemy general whenever you activate your bbs', function() {
			...
			var whiplash = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction2.Whiplash}, 4, 3, gameSession.getPlayer1Id());
		...
		it('expect ethereal blades to give a friendly minion and your general +2 attack this turn', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
		...
		it('expect geomancer to turn your BBS into phoenix fire', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			...
			var geomancer = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction2.Geomancer}, 4, 3, gameSession.getPlayer1Id());
		...
		it('expect obscuring blow to give a friendly minion or general backstab(2)', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();

			var whiplash = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction2.Whiplash}, 4, 3, gameSession.getPlayer1Id());
			var ironcliffe = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction1.IroncliffeGuardian}, 3, 3, gameSession.getPlayer2Id());
			...
			var action = whiplash.actionAttack(ironcliffe);
			gameSession.executeAction(action);

			expect(ironcliffe.getDamage()).to.equal(6);
			expect(whiplash.getDamage()).to.equal(0);
		});
		it('expect cobra strike to deal 3 damage to an enemy minion and the enemy general', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;

			var geomancer = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction2.Geomancer}, 4, 3, gameSession.getPlayer2Id());
		...
		it('expect twilight fox to teleport a random enemy minion behind your general when you use your bbs', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;
			...
			var twilightfox = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction2.TwilightFox}, 4, 3, gameSession.getPlayer1Id());
			var squire = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction1.SilverguardSquire}, 6, 1, gameSession.getPlayer2Id());
		...
		it('expect twilight fox to not teleport a random enemy when you use your bbs if there is no space', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
		...
		it('expect twilight fox to not teleport an enemy behind your general if blocked and for onyx jaguar to not activate', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
			player1.remainingMana = 9;
			...
			var twilightfox = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction2.TwilightFox}, 4, 3, gameSession.getPlayer1Id());
			var jaguar = UtilsSDK.applyCardToBoard({id: SDK.Cards.Faction2.OnyxJaguar}, 6, 1, gameSession.getPlayer2Id());
