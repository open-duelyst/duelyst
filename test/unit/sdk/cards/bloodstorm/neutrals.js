...
describe("bloodstorm", function() {
	describe("neutrals", function(){
		...
		it('expect cryptographer to refresh your bbs', function() {
		...
		it('expect sanguinar to make your normal bbs cost 1 less', function() {
			var gameSession = SDK.GameSession.getInstance();
			var board = gameSession.getBoard();
			var player1 = gameSession.getPlayer1();
		...
		*/
		...
		it('expect meltdown to deal 6 damage to a random enemy whenever you activate your bbs', function() {
			...
			var totalDamage = ironcliffe.getDamage() + gameSession.getGeneralForPlayer2().getDamage();
